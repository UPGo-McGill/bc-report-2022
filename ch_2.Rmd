...
Since 2016, BC tenants have paid more than \$3 trillion in rent. During the same time period, we estimate that `attributed_to_str_2016_2021` (\$`overpaid_2016_2021` billion) of this amount was due to the STR market activity. The year prior to the COVID-19 pandemic, 2019, at the peak of the STR market in British Columbia, `attributed_to_str_2019` of the total prices of rent were overpaid by tenants due to STR market activities.

From 2016 to 2019, the amount of rent overpaid by tenants was increasing. In 2016, the percentage of rent overpaid due to the STR market activity was `every_year_overpaid[["2016"]]`, `every_year_overpaid[["2017"]]` in 2017, `every_year_overpaid[["2018"]]` in 2018, and `every_year_overpaid[["2019"]]` in 2019. This suggests that the percentage of rent attributed to STR market activity would have continued to increase if it were not for the COVID-19 pandemic. However, the rate of increase was marginally decreasing, suggesting that it would have eventually reached a plateau in future years.
