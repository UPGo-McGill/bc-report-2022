...
To measure the impact of STRs on housing affordability in British Columbia, we developed a fixed-effect linear regression model predicting average rents as a function of the per-dwelling prevalence of frequently-rented entire home listings. in We used the October yearly average rents disclosed by the CMHC from 2016 to 2021 for every region in British Columbia with available data. Our models shows a strong positive relationship between the concentration of FREH listings and average rents.
