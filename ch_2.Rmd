...
If the province's STR market returns to its pre-pandemic trajectory by the end of 2023, this would imply that there will be `housing_loss_2023` housing units operating as dedicated STRs---a `housing_loss_change_2021_2023` increase over the actual number as of the end of 2021. This implies that STR activity will drive up average monthly rents in medium and large cities in the province by `rent_inc_monthly_2021_2023` above their levels at the end of 2021.
